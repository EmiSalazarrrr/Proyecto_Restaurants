...
urlpatterns = [
    ...
    path('mi-ticket/<int:ticket_id>/', pedidos_views.ver_ticket, name='ver_ticket'),
    path('tickets/<int:id_ticket>/modificar/', pedidos_views.modificar_ticket, name='modificar_ticket'),
    path('tickets/<int:id_ticket>/eliminar-item/<int:alimento_id>/', pedidos_views.eliminar_item_ticket, name='eliminar_item_ticket'),
    ...
    path('mis-tickets/', pedidos_views.mis_tickets_view, name='mis_tickets'),
    path('mis-tickets/<int:ticket_id>/canjear/', pedidos_views.canjear_directo, name='canjear_directo'),
    ...
    path('tickets/<int:id_ticket>/reabrir/', pedidos_views.reabrir_ticket, name='reabrir_ticket'),
    path('promociones/', promociones_views.promociones_view, name='promociones'),
    path('promociones/<int:promocion_id>/toggle-estado/', promociones_views.toggle_estado_view, name='toggle_estado'),
